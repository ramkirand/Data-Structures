...
public class LinkList {
	...
	public static LinkNode reverseKBlocks(LinkNode head, int k) {
	...
	public static LinkNode reverseKAlternateNodes(LinkNode headptr, int k) {
		int listLen = 0;
		while (headptr != null) {
			listLen++;
			headptr = headptr.getNext();
	...
	public static void main(String[] args) {
		...
		//L.head = reverseKBlocks(L.head,1);(
		L.head = reverseKAlternateNodes(L.head,2);
//		L.seperateOddEven(L.head);
		L.displayList(L.head);
